...
/**=======================================================================================================================**/
/**=======================================================================================================================**/
individual_t* createRequest(const char *r_username) {
...
JNIEXPORT jint JNICALL Java_petrsu_smartroom_android_srcli_KP_registerRequest(
    ...
    individual_t* request = createRequest(p_username);
...
/**=======================================================================================================================**/
/**=======================================================================================================================**/
JNIEXPORT jint JNICALL Java_petrsu_smartroom_android_srcli_KP_deleteRequest(JNIEnv *env, jclass clazz, jstring username) {
        ...
        list_for_each(pos, &list->links) {
           ...
           sslog_ss_populate_individual(request);
			...
			if(strcmp(username, (char *)username_value->prop_value) == 0) {
				 if (sslog_ss_remove_individual(request) != 0) return 3;
			}
        }
    } else {
        return -1;
